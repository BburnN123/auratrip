...
async def main():
    ...
    for sig in (signal.SIGINT, signal.SIGTERM):
        try:
            ...
            # Some event loop implementations on Windows don't support
            # add_signal_handler (raises NotImplementedError). Fall back
            # to default signal handling and continue.
            pass
